import { ConnectRequest, type DappInfo, SignAndSubmitTransactionRequest, SignAndSubmitTransactionResponse, SignMessageRequest, SignMessageResponse, SignTransactionRequest, SignTransactionResponse } from '@aptos-connect/wallet-api';
...
export declare class ACDappClient {
    ...
    constructor({ backendBaseURL, dappId, dappImageURI, dappName, defaultNetworkName, frontendBaseURL, provider, tgWebAppURL, }?: ACDappClientConfig);
    ...
    connect({ claimOptions, preferredWalletName, }?: Omit<ConnectRequest.Args, 'dappId' | 'dappEd25519PublicKeyB64'>): Promise<import("@aptos-connect/wallet-api").UserDismissal | import("@aptos-connect/wallet-api").UserApproval<{
